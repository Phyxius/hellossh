...
{
    // https://stackoverflow.com/a/38884095
    ...
    internal class ArrayMarshaler<T> : ICustomMarshaler
    {
        ...
        public object MarshalNativeToManaged(IntPtr pNativeData)
        {
            ...
            uint length = ReadUint32(pNativeData);
        ...
        public IntPtr MarshalManagedToNative(object ManagedObject)
        {
            ...
            WriteUint32(ptr, (uint)array.Length);
        ...
        private void WriteUint32(IntPtr ptr, uint val)
        {
        ...
        private uint ReadUint32(IntPtr ptr)
        {
            var bs = new byte[sizeof(uint)];
            for (int i = 0; i < bs.Length; i++)
            {
                bs[i] = Marshal.ReadByte(ptr, i);
            }
